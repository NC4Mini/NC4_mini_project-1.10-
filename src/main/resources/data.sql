...
insert into board (created_time, updated_time, board_contents, board_category, board_title, board_hits, board_writer, file_attached) values
('2024-01-01', '2024-01-01', '사이즈가 작아요', 'test1', '반품신청합니다', '0', '신지우', 0),
('2024-01-01', '2024-01-01', '사이즈가 작아요', 'test2', '교환신청합니다', '0', '김종범', 0),
('2024-01-01', '2024-01-01', 'ㅇㄴㅇㄴㅇㄴㅇ', 'test3', '환불신청합니다', '0', '아무개', 0)
;
